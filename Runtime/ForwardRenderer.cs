...
namespace UnityEngine.Rendering.Universal {
    ...
    public sealed class ForwardRenderer : ScriptableRenderer {
        ...
        public ForwardRenderer(ForwardRendererData data) : base(data)
        {
            ...
            m_BlendBlitMaterial = CoreUtils.CreateEngineMaterial(data.shaders.blendBlitPS);
            m_BlitFlipMaterial = CoreUtils.CreateEngineMaterial(data.shaders.blitFlipPS);
            ...
            m_CopyColorTransparentPass = new CopyColorPass(RenderPassEvent.AfterRenderingTransparents, m_SamplingMaterial);
            ...
            m_FinalBlitPass = new FinalBlitPass(RenderPassEvent.AfterRendering + 1, m_BlitMaterial, m_BlendBlitMaterial);
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            CoreUtils.Destroy(m_BlendBlitMaterial);
            CoreUtils.Destroy(m_BlitFlipMaterial);
...
#pragma warning restore 0618
            ...
            bool lastCameraInTheStack = cameraData.resolveFinalTarget && setup.intermediateRenderTexture;
...
#endif
            setup.createColorTexture = RequiresIntermediateColorTexture(ref cameraData) ||
        ...
        bool RequiresIntermediateColorTexture(ref CameraData cameraData)
        {
            ...
            bool requiresBlitForOffscreenCamera = cameraData.postProcessEnabled || cameraData.requiresOpaqueTexture || cameraData.requiresTransparentTexture || requiresExplicitMsaaResolve || !cameraData.isDefaultViewport;
